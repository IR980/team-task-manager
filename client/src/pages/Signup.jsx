    ...
    <div className="auth-page">
      ...
      <div className="auth-box">
        <div className="auth-card">
          ...
          <div className="auth-sub">Start managing tasks with your team</div>
          ...
          <form className="auth-form" onSubmit={submit}>
            <div className="form-group">
              ...
              <input className="form-input" type="text" name="name" value={form.name} onChange={handle} placeholder="Alex Johnson" required />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              <input className="form-input" type="password" name="password" value={form.password} onChange={handle} placeholder="Min. 6 characters" required minLength={6} />
            </div>
